...
N = 1951
M = 100000
path = _os.path.join(_HERE,'..','data','hecke_eigenvalues_doud1951_to1e5.csv')
...
np.save(_os.path.join(_HERE,'..','results','certificate_results.npy'), np.array(results, dtype=object), allow_pickle=True)
with open(_os.path.join(_HERE,'..','results','certificate_results.tsv'), 'w') as f:
