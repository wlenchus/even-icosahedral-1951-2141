...
_coeffs = _os.path.join(_HERE,'..','results','adjoint_coefficients.gp')
...
_gpfile = _os.path.join(_HERE,'..','results','adjoint_run.gp')
open(_gpfile,'w').write(gp_script)
_out = _os.path.join(_HERE,'..','results','adjoint_L_gp_output.txt')
